...
module VCAP::CloudController
  describe SpaceAccess, type: :access do
    ...
    describe '#update_related_object?' do
      let(:params) { { verb: verb, relation: relation, related_guid: related_guid } }
      let(:space) { object }
      ...
      context 'when adding' do
        ...
        it 'delegates to update? even when changing the current user' do
          expect(access).to receive(:update?).with(space, params).and_return('bob')
          expect(access.update_related_object?(space, params)).to eq('bob')
        end
      end
      ...
      context 'when removing' do
        ...
        context 'with auditors' do
          ...
          context 'when acting against themselves' do
            ...
            it 'is true' do
              expect(access.update_related_object?(space, params)).to be true
            end
          end
          ...
          context 'when acting against another' do
            ...
            it 'is false' do
              expect(access.update_related_object?(space, params)).to be false
            end
          end
        end
