...
describe CloudController::ServiceInstanceBindingManager do
  let(:manager) { CloudController::ServiceInstanceBindingManager.new(access_validator, logger) }
    ...
    context 'user provided service instance' do
      ...
      context 'when route services are disabled' do
        ...
        it 'raises a RouteServiceDisabled error' do
          ...
          }.to raise_error CloudController::ServiceInstanceBindingManager::RouteServiceDisabled
        end
      end
    end
    ...
    context 'managed service instance' do
      ...
      context 'when the route does not exist' do
        it 'raises a RouteNotFound error and does not call the broker' do
          ...
          }.to raise_error CloudController::ServiceInstanceBindingManager::RouteNotFound
      ...
      context 'when the service instance does not exist' do
        it 'raises a ServiceInstanceNotFound error' do
          ...
          }.to raise_error CloudController::ServiceInstanceBindingManager::ServiceInstanceNotFound
      ...
      context 'when the route is already bound to a service_instance' do
        ...
        it 'raises a already bound to service instance error' do
          expect {
            manager.create_route_service_instance_binding(route.guid, service_instance.guid, arbitrary_parameters, route_services_enabled)
          }.to raise_error CloudController::ServiceInstanceBindingManager::RouteAlreadyBoundToServiceInstance
      ...
      context 'when the route is already bound to the same service_instance' do
        ...
        it 'raises a service already bound to same route error' do
          expect {
            manager.create_route_service_instance_binding(route.guid, service_instance.guid, arbitrary_parameters, route_services_enabled)
          }.to raise_error CloudController::ServiceInstanceBindingManager::ServiceInstanceAlreadyBoundToSameRoute
        ...
        context 'when the route has an app', isolation: :truncation do
          ...
          context 'when the app does not use diego' do
            ...
            it 'raises an error' do
              expect {
                manager.create_route_service_instance_binding(route.guid, service_instance.guid, arbitrary_parameters, route_services_enabled)
              }.to raise_error(CloudController::ServiceInstanceBindingManager::RouteServiceRequiresDiego)
            end
          end
        end
      end
      ...
      context 'when the service is not bindable' do
        ...
        it 'raises ServiceInstanceNotBindable' do
          expect {
            manager.create_route_service_instance_binding(route.guid, service_instance.guid, arbitrary_parameters, route_services_enabled)
          }.to raise_error(CloudController::ServiceInstanceBindingManager::ServiceInstanceNotBindable)
    ...
    context 'managed service instances' do
      ...
      context 'when the route and service instance are not bound' do
        it 'raises a RouteBindingNotFound error' do
          ...
          }.to raise_error CloudController::ServiceInstanceBindingManager::RouteBindingNotFound
  ...
  describe '#create_app_service_instance_binding' do
    ...
    context 'when the app does not exist' do
      it 'raises AppNotFound' do
        ...
        }.to raise_error(CloudController::ServiceInstanceBindingManager::AppNotFound)
      end
    end
    ...
    context 'when volume mount services are disabled and the service requires volume_mount' do
      ...
      it 'raises a VolumeMountServiceDisabled error' do
        expect {
          manager.create_app_service_instance_binding(service_instance.guid, app.guid, binding_attrs, arbitrary_parameters, volume_mount_services_enabled)
        }.to raise_error CloudController::ServiceInstanceBindingManager::VolumeMountServiceDisabled
      end
    end
  end
end
