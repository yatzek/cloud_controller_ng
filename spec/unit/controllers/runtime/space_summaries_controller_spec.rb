...
describe CloudController::SpaceSummariesController do
  ...
  before do
    ...
    allow_any_instance_of(CloudController::SpaceSummariesController).to receive(:instances_reporters).and_return(instances_reporters)
    app_obj.reload
