...
describe CloudController::RestagesController do
  ...
  describe 'POST /v2/apps/:id/restage' do
    ...
    context 'as a developer' do
      ...
      it 'restages the app' do
        allow_any_instance_of(CloudController::RestagesController).to receive(:find_guid_and_validate_access).with(:read, application.guid).and_return(application)
      ...
      context 'with a Docker app' do
        ...
        context 'when there are validation errors' do
          before do
            allow_any_instance_of(CloudController::RestagesController).to receive(:find_guid_and_validate_access).with(:read, docker_app.guid).and_return(docker_app)
