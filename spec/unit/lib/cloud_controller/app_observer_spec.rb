  ...
  describe '.deleted' do
    ...
    context 'diego app' do
      ...
      it 'does not care if diego is unavailable' do
        allow(runner).to receive(:stop).and_raise(::Diego::Runner::CannotCommunicateWithDiegoError)
    ...
    context 'when the app state is changed' do
      ...
      context 'if the desired app state is started' do
        ...
        context 'diego app' do
          ...
          it 'does not care if diego is unavailable' do
            allow(runner).to receive(:start).and_raise(::Diego::Runner::CannotCommunicateWithDiegoError)
            expect { subject }.not_to raise_error
          end
        end
      end
    ...
    context 'when the app instances have changed' do
      ...
      context 'if the desired state of the app is started' do
        ...
        context 'diego app' do
          ...
          it 'does not care if diego is unavailable' do
            allow(runner).to receive(:scale).and_raise(::Diego::Runner::CannotCommunicateWithDiegoError)
            expect { subject }.not_to raise_error
          end
        end
      end
  ...
  describe '.routes_changed' do
    ...
    context 'when the app is started' do
      ...
      context 'diego app' do
        ...
        it 'does not care if diego is unavailable' do
          allow(runner).to receive(:update_routes).and_raise(::Diego::Runner::CannotCommunicateWithDiegoError)
          expect { subject }.not_to raise_error
        end
      end
    end
