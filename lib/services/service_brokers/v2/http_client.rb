  ...
  module ServiceBrokers::V2
    ...
    class HttpClient
      ...
      def initialize(attrs, logger=nil)
        ...
        @broker_client_timeout = Config.config[:broker_client_timeout_seconds] || 60
      ...
      def default_headers
        {
          VCAP::Request::HEADER_BROKER_API_VERSION => '2.8',
          VCAP::Request::HEADER_NAME => VCAP::Request.current_id,
          'Accept' => 'application/json',
          VCAP::Request::HEADER_API_INFO_LOCATION => "#{Config.config[:external_domain]}/v2/info"
        }
      end
