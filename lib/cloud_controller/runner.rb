...
class Runner
  ...
  def run!
    ...
    EM.run do
      begin
        ...
        request_metrics = Metrics::RequestMetrics.new(statsd_client)
  ...
  def collect_diagnostics
    ...
    file = Diagnostics.new.collect(@diagnostics_dir, periodic_updater)
