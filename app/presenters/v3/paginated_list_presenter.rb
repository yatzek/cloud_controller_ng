...
module Presenters
  module V3
    class PaginatedListPresenter
      PRESENTERS = {
        'App'                 => Presenters::V3::ProcessPresenter,
        'AppModel'            => Presenters::V3::AppPresenter,
        'DropletModel'        => Presenters::V3::DropletPresenter,
        'PackageModel'        => Presenters::V3::PackagePresenter,
        'RouteMappingModel'   => Presenters::V3::RouteMappingPresenter,
        'ServiceBindingModel' => Presenters::V3::ServiceBindingModelPresenter,
        'TaskModel'           => Presenters::V3::TaskPresenter,
      }.freeze
