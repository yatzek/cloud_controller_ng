class AppModel < Sequel::Model(:apps_v3)
  ...
  one_to_many :service_bindings, class: 'ServiceBindingModel', key: :app_id
  one_to_many :tasks, class: 'TaskModel', key: :app_id

  many_to_one :space, class: 'Space', key: :space_guid, primary_key: :guid, without_guid_generation: true
  ...
  one_to_many :packages, class: 'PackageModel', key: :app_guid, primary_key: :guid
  one_to_many :droplets, class: 'DropletModel', key: :app_guid, primary_key: :guid
  many_to_one :droplet, class: 'DropletModel', key: :droplet_guid, primary_key: :guid, without_guid_generation: true

  one_to_one :buildpack_lifecycle_data,
              class: 'BuildpackLifecycleDataModel',
              key: :app_guid,
              primary_key: :guid
  ...
  def validate_environment_variables
    ...
    validator = Validators::EnvironmentVariablesValidator.new({ attributes: [:environment_variables] })
