module Jobs
  module Services
    class ServiceInstanceStateFetch < Jobs::CCJob
      ...
      def new_end_timestamp
        Time.now + Config.config[:broker_client_max_async_poll_duration_minutes].minutes
      end
      ...
      def update_polling_interval
        default_poll_interval = Config.config[:broker_client_default_async_poll_interval_seconds]
