module Jobs
  module V3
    class PackageBitsCopier < Jobs::CCJob
      ...
      def perform
        ...
        dest_package = PackageModel.find(guid: @dest_package_guid)
        raise 'destination package does not exist' unless dest_package
        src_package = PackageModel.find(guid: @src_package_guid)
        ...
        dest_package.db.transaction do
          ...
          dest_package.state        = PackageModel::READY_STATE
          dest_package.save
        end
        ...
        if dest_package
          dest_package.db.transaction do
            dest_package.lock!
            dest_package.state = PackageModel::FAILED_STATE
